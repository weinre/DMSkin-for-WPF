...
namespace DMSkin.WPF.Controls
{
    public class DMThumb:Thumb
    {
        ...
        public static readonly DependencyProperty ThemeColorProperty =
            DependencyProperty.Register("ThemeColor", typeof(SolidColorBrush), typeof(DMThumb), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(90, 88, 88, 88)))); 
        #endregion
        ...
        public static readonly DependencyProperty ThemeColorMouseOverProperty =
            DependencyProperty.Register("ThemeColorMouseOver", typeof(SolidColorBrush), typeof(DMThumb), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(120,88, 88, 88)))); 
        #endregion
        ...
        public static readonly DependencyProperty ThemeColorPressedProperty =
            DependencyProperty.Register("ThemeColorPressed", typeof(SolidColorBrush), typeof(DMThumb), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(100, 88,88,88))));
        #endregion
        ...
        public static readonly DependencyProperty RadiusXProperty =
            DependencyProperty.Register("RadiusX", typeof(double), typeof(DMThumb), new PropertyMetadata(0.0));
        #endregion
        ...
        public static readonly DependencyProperty RadiusYProperty =
            DependencyProperty.Register("RadiusY", typeof(double), typeof(DMThumb), new PropertyMetadata(0.0)); 
        #endregion
    }
}
